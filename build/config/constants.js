...
exports.workers = exports.webRequestTimeout = exports.updatedFile = exports.tvdb = exports.trakt = exports.tmdb = exports.timeZone = exports.tempDir = exports.statusFile = exports.showMap = exports.server = exports.Promise = exports.port = exports.pageSize = exports.movieMap = exports.maxWebRequest = exports.master = exports.omdb = exports.nyaaAnimeProviders = exports.katShowProviders = exports.katMovieProviders = exports.katAnimeProviders = exports.fanart = exports.extratorrentShowProviders = exports.extratorrentMovieProviders = exports.extratorrentAnimeProviders = exports.dbName = exports.dbHosts = exports.cronTime = exports.collections = exports.animeMap = undefined;

var _fanart = require("fanart.tv-api");

var _fanart2 = _interopRequireDefault(_fanart);
...
var _themoviedbclient = require("themoviedbclient");

var _themoviedbclient2 = _interopRequireDefault(_themoviedbclient);
 ...
 * @type {Array}
 */
var collections = exports.collections = ["anime", "movie", "show"];

/**
 * The cron time for scraping torrents. Default is `0 0 *\/6 * * *`.
 * @type {String}
 */
var cronTime = exports.cronTime = "0 0 */6 * * *";

/**
 * The host of the server of the database. Default is `["localhost"]`.
 * @type {Array}
 */
var dbHosts = exports.dbHosts = ["localhost"];

/**
 * The name of the database. Default is `popcorn`.
 * @type {String}
 */
var dbName = exports.dbName = "popcorn";

/**
 * The providers for scraping ExtraTorrent for anime.
 * @type {Array}
 */
var extratorrentAnimeProviders = exports.extratorrentAnimeProviders = [];

/**
 * The providers for scraping ExtraTorrent for movies.
 * @type {Array}
 */
var extratorrentMovieProviders = exports.extratorrentMovieProviders = [
 ...
 * @type {Array}
 */
var extratorrentShowProviders = exports.extratorrentShowProviders = [
// 480p
{ name: "ETTV LOL", query: { with_words: "ettv hdtv x264 lol", without: "720p 1080p" } }, { name: "ETTV KILLERS", query: { with_words: "ettv hdtv x264 killers", without: "720p 1080p" } }, { name: "ETTV 2HD", query: { with_words: "ettv hdtv x264 2hd", without: "720p 1080p" } }, { name: "ETTV CROOKS", query: { with_words: "ettv hdtv x264 crooks", without: "720p 1080p" } }, { name: "ETTV FUM", query: { with_words: "ettv hdtv x264 fum", without: "720p 1080p" } }, { name: "ETTV BATV", query: { with_words: "ettv hdtv x264 batv", without: "720p 1080p" } }, { name: "ETTV ASAP", query: { with_words: "ettv hdtv x264 asap", without: "720p 1080p" } }, { name: "ETTV TLA", query: { with_words: "ettv hdtv x264 tla", without: "720p 1080p" } }, { name: "ETTV W4F", query: { with_words: "ettv hdtv x264 w4f", without: "720p 1080p" } }, { name: "ETTV EVOLVE", query: { with_words: "ettv hdtv x264 EVOLVE", without: "720p 1080p" } }, { name: "ETTV ORGANiC", query: { with_words: "ettv hdtv x264 organic", without: "720p 1080p" } }, { name: "ETTV BAJSKORV", query: { with_words: "ettv hdtv x264 bajskorv", without: "720p 1080p" } }, { name: "ETTV RiVER", query: { with_words: "ettv hdtv x264 river", without: "720p 1080p" } },

// 720p
{ name: "ETTV 720p", query: { with_words: "ettv hdtv x264 720p" } }, { name: "ETHD 720p", query: { with_words: "ethd hdtv x264 720p" } },
...
var fanart = exports.fanart = new _fanart2.default({
 ...
 * @type {Array}
 */
var katAnimeProviders = exports.katAnimeProviders = [];

/**
 * The providers for scraping KAT for movies.
 * @type {Array}
 */
var katMovieProviders = exports.katMovieProviders = [
// English providers
{ name: "Megaradon", query: { query: "x264 720p | 1080p", uploader: "megaradon", language: "en" } }, { name: "Z0n321", query: { query: "x264 720p | 1080p", uploader: "z0n321", language: "en" } },
 ...
 * @type {Array}
 */
var katShowProviders = exports.katShowProviders = [
// 720p and 1080p providers
{ name: "Zoner720p", query: { query: "x264 720p", uploader: "z0n321" } }, { name: "Zoner1080p", query: { query: "x264 1080p", uploader: "z0n321" } }, { name: "Brasse0", query: { query: "x264", uploader: "brasse0" } }, { name: "ETHD", query: { query: "x264", uploader: "ethd" } },

// Uploader providers
{ name: "ETTV", query: { query: "x264", uploader: "ettv" } }, { name: "KAT_EZTV", query: { query: "x264", uploader: "eztv" } }, { name: "VTV", query: { query: "x264", uploader: "vtv" } }, { name: "SRIGGA", query: { query: "x264", uploader: "ethd" } },
 ...
 * @type {Array}
 */
var nyaaAnimeProviders = exports.nyaaAnimeProviders = [{ name: "Commie", query: { term: "mkv", user: 76430, filter: "trusted_only" } }, { name: "FFF", query: { term: "mkv", user: 73859, filter: "trusted_only" } }, { name: "gg", query: { term: "mkv", user: 9001, filter: "trusted_only" } }];
 ...
 * @type {String}
 */
var statusFile = exports.statusFile = "status.json";

/**
 * The path to the temprary directory.. Default is `./tmp`.
 * @type {String}
 */
var tempDir = exports.tempDir = _path2.default.join(process.cwd(), "tmp");

/**
 * The timezone the conjob will hold. Default is `America/Los_Angeles`.
 * @type {String}
 */
var timeZone = exports.timeZone = "America/Los_Angeles";
 ...
 */
var tmdb = exports.tmdb = new _themoviedbclient2.default("2592f66235042e3e31705e3d56da0a69");
 ...
 * @see https://github.com/vankasteelj/trakt.tv
 */
var trakt = exports.trakt = new _trakt2.default({
